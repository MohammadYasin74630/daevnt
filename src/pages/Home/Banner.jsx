...
function Banner() {
  return (
    <>
      <header className="h-[100vmax] md:h-[100vmin] relative max-sm:mb-32">
        ...
        <div className="absolute w-10/12 left-1/2 -translate-x-1/2 bottom-10 h-2/5 md:h-2/4 p-4 max-w-7xl">
          <div className="relative h-full">
            ...
            <div className="md:flex justify-between absolute bottom-0 w-full">
              <p className="text-xl md:text-2xl lg:text-4xl xl:text-5xl uppercase font-extrabold leading-snug">Join Ultimate <br /> Online Conference Experience</p>
